...
<head>
    ...
    <title>Pagina de Autentificare - TranziteRO</title>
...
<body>
    ...
    <div class="form-container">
        <div class="wrapper">
            ...
            <h4>Autentificare pe TranziteRO</h4>
            <form action="#" method="POST">
                <!-- Email Field -->
                <div class="mb-3">
                    <label for="email" class="form-label">Adresă de email</label>
                    <input type="email" class="form-control fadeIn second" id="email" name="email" required>
                </div>

                <!-- Password Field -->
                <div class="mb-3">
                    <label for="password" class="form-label">Parolă</label>
                    <input type="password" class="form-control fadeIn third" id="password" name="password" required>
                </div>

                <!-- Submit Button -->
                <div class="d-grid gap-2">
                    <button type="submit" class="fadeInButton">Autentificare</button>
                </div>
            </form>
        </div>
    </div>
